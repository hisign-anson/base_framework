...
import com.hisign.shuwu.common.constant.Constants.DateType;
import com.hisign.shuwu.common.constant.DateStyle;
...
public class DateUtil {
	...
	public static Date[] getDateSection(int dateType,Date date){
		...
		if (dateType==DateType.YEAR) {//年度
			calendar.set(Calendar.MONTH, 1);
			arr[0] = calendar.getTime();
			calendar.add(Calendar.YEAR, 1);
			arr[1] = calendar.getTime();
		}else if (dateType == DateType.QUARTER) {//季度 1-3  4-6 7-9 10-12
