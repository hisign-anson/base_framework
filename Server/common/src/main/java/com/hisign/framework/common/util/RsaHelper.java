package com.hisign.framework.common.util;
...
public class RsaHelper {
    ...
    public static byte[] signData(byte[] data, PrivateKey priKey,
        ...
        try {
            ...
            logger.error("根据指定私钥和算法对数据进行签名", ex);
            return null;
        }
    }
