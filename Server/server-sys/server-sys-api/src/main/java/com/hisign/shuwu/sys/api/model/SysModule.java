...
public class SysModule extends BaseModel {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4423411521801315276L;
	private String id;
	/**
     *模块编号
     */
     ...
     * 子模块集合
     */
    private List<SysModule> sonMouleList;
    ...
    public String getModuleNo() {
        if(this.moduleNo==null||"".equals(this.moduleNo)){
    ...
    public List<SysModule> getSonMouleList() {
        return sonMouleList;
    }

    public void setSonMouleList(List<SysModule> sonMouleList) {
        this.sonMouleList = sonMouleList;
    }
}
